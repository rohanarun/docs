...
Download for Windows and Mac at [https://openagent.studio .](https://openagent.studio)

Windows Install instructions:

<iframe width="560" height="315" src="https://www.youtube.com/embed/8xhFKkD4H-0?si=tlOMc3SsQQrmPlkB" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen />
...
<video controls className="w-full aspect-video" src="https://storage.googleapis.com/cheatlayer/finsta.mp4" />

Installing Open Agent Studio locally, or on-premise, requires an enterprise license. Please contact [support@cheatlayer.com](mailto:support@cheatlayer.com) for details.

### Windows Install Instructions

1. Download and extract cheatlayer.zip
2. Double click cheatlayer.exe to open and click "more info" and "run anyway" if it asks.
3. Enter your Cheat Layer API key you can find at the bottom of the billing page at cheatlayer.com/billing.

### Mac Install Instructions

1. Under "Privacy and Security" in your settings, add "terminal" to "Accessability", "Screen Recording", and "Full Disk Access".
2. Double click the unzipped app--it will close.
3. Open Privacy and Security "General" tab and click "run anyway" next to Cheat Layer.

### Linux Install Instructions

1. Download main.zip
2. Extract main.zip
3. Set ENV variable CHEAT_KEY with your cheatlayer.com/billing API key .
4. ./main to run
