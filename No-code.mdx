...
|------------------------------------|---------------------|
| "Current Directory" in saved       | Write resource path |
| "resource_path" in key             | Write resource path |
| "backspace" in key                 | Press backspace     |
| "space" in key                     | Write space         |
| "period" in key                    | Write period (.)    |
| "slash" in key                     | Write slash (/)     |
| "return" in key                    | Press enter         |
| "shift" in key                     | Hold shift key      |
| "ctrl" in key                      | Hold ctrl key       |
| "alt" in key                       | Hold alt key        |
| "tab" in key                       | Hold tab key        |
| "enter" in key                     | Press enter         |
